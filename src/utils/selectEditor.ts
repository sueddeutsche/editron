...
interface EditorConstructor {
    editorOf(pointer, editron, options): boolean;
}
 ...
 *  or is denied
 */
function select(editors: Array<EditorPlugin>, pointer: JSONPointer, editron: Editron, options): EditorPlugin|false|undefined {
