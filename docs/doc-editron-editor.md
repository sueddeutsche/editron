...
> Here, all required tasks of a custom _editor_, quirks and conventions are documented in detail. If you are looking for a simpler approach, read the [howto of writing a custom value editor](howto-write-value-editor.md), using the _AbstractValueEditor_ helper.
...
1. append your node within the view on some kind of _on-create-hook_ 
2. use _document.querySelector_ to fetch the _parent-node_ of a prerendered view and append your node
