...
export default {
    ...
    view(vnode) {
        ...
        }, m(".ed-header__title", populated(vnode.attrs.icon, m("i.mmf-icon", attrs.icon)), (!attrs.hideTitle) && m("h2", attrs.title), vnode.children), vnode.attrs.headerContent && m(CHILD_CONTAINER_SELECTOR), (actions === null || actions === void 0 ? void 0 : actions.length) > 0 && m(".ed-header__actions", actions.map(action => renderAction(action))));
    }
};
